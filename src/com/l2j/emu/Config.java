...
import com.l2j.emu.commons.config.ExProperties;
import com.l2j.emu.commons.logging.CLogger;
import com.l2j.emu.commons.math.MathUtil;
import com.l2j.emu.gameserver.enums.GeoType;
import com.l2j.emu.gameserver.model.holder.IntIntHolder;
...
public class Config {
    ...
    public static final String EVENTS_FILE = "./config/clans.properties";
    public static final String GEOENGINE_FILE = "./config/clans.properties";
    public static final String HEXID_FILE = "./config/clans.properties";
    public static final String LOGINSERVER_FILE = "./config/clans.properties";
    public static final String NPCS_FILE = "./config/clans.properties";
    public static final String PLAYERS_FILE = "./config/clans.properties";
    public static final String SERVER_FILE = "./config/clans.properties";
    public static final String SIEGE_FILE = "./config/clans.properties";
...
//     ##################
    ...
    public static boolean MEMBERS_CAN_WITHDRAW_FROM_CLAN_WAREHOUSE;
...
//     #####################################
//     # Секция скрытых серверных настроек #
//     #####################################

    // Зарезервировать хост на LoginServerThread
    ...
    // Настройки очереди клиентских пакетов
    ...
    /**
     * Инициализирует {@link ExProperties} из конфигурационного файла.
     *
     * @param fileName : Файл для загрузки.
     * @return ExProperties : инициализированный {@link ExProperties}.
     */
    public static ExProperties initProperties(String fileName) {
        ...
        try {
            ...
            logger.error("An error occurred loading '{}' config.", e, fileName);
        }
        return result;
    }

    /**
     * Загружает настройки клана и клан-холлов
     */
    private static void loadClans() {
        ...
        MEMBERS_CAN_WITHDRAW_FROM_CLAN_WAREHOUSE = clans.getProperty("MembersCanWithdrawFromClanWH", false);
    ...
    /**
     * Загружает настройки эвентов.<br>
     * Таких, как олимпиада, фестиваль 7 печатей, four sepulchres, рифт, свадьба, лотерея, чемпионат по рыбалке
     */
    ...
    /**
     * Загружает настройки Гео движка.
     */
    ...
    /**
     * Сохраняет hex ID файл
     *
     * @param serverId : ID сервера.
     * @param hexId    : hex ID сервера.
     */
    ...
    /**
     * Загружает настройки NPC.<br>
     * Такие, как монстры-чемпионы, NPC buffer, класс-мастер, выверны, рейд боссы и эпик рейд Боссы, AI
     */
    ...
    /**
     * Загружает настройки игрока.<br>
     * Такие, как инвентарь/хранилище, заточка, аугментация, карма, группа, админ, петиция, изучение умений
     */
    ...
    /**
     * Загружает настройки гейм-сервера <br>
     * IP адрес, база данных, рейты, feature enabled/disabled, разное.
     */
    ...
    /**
     * Загружает настройки логин-сервера <br>
     * IP адрес, база данных, аккаунт, разное.
     */
    ...
    public static final class ClassMasterSettings {
        ...
        private void parse(final StringTokenizer st, List<IntIntHolder> holderList) {
            if (st.hasMoreTokens()) {
                StringTokenizer st2 = new StringTokenizer(st.nextToken(), "[],");
                while (st2.hasMoreTokens()) {
                    StringTokenizer st3 = new StringTokenizer(st2.nextToken(), "()");
                    holderList.add(new IntIntHolder(Integer.parseInt(st3.nextToken()), Integer.parseInt(st3.nextToken())));
                }
            }
        }
    }
